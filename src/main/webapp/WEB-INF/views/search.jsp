...
<title><spring:message code="label.imperial.search" /></title>
				...
				<table cellspacing="0" cellpadding="0" id="submain">
					<tr valign="top">
						<td width="30%" id="lft"><img
							...
							class="h1but">
							<div class="h11">
								<a href="<c:url value="/search{locale}" />" class="roboto5"> <c:if
										test="${!empty category}"><c:choose>
						...
						<td class="lh" style="padding: 0 23px;">
							...
							<div style="position: relative; top: -230px; clear: both;">
								...
								<c:if test="${!empty listSearchR}">
									<div class="navigator">
										<div id="navigator">
											<br><spring:message code="label.records" /> ${page.lengthOfSearch}<br>
											...
											<c:forEach items="${navList}" var="nav">
												<c:choose>
													...
													<c:otherwise>
													[ <a href="<c:url value="/search/nav/${nav.id}" />">

	...
	function ugCheckForErrors(galleryID, type){
		...
		errorMessage = "<div style='font-size:16px;color:#BC0C06;max-width:640px;border:1px solid red;padding:10px;'>" + errorMessage + "</div>"
...
function UniteGalleryMain(){
	...
	var g_options = {				
			...
			gallery_height:380,							//gallery height
